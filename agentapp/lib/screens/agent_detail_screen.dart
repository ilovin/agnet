        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              // Task #12: removed the right-side keyboard IconButton —
              // it duplicated the "+" ComposerPlusButton on the left
              // edge, which already opens _showSpecialKeysSheet. The
              // composer now reads: [+] [ TextField with send-arrow
              // suffix ].
            ],
          ),
        ],
