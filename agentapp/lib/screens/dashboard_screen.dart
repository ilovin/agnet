...
class _MarkdownText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Multi-paragraph rendering: between paragraphs we insert a low-contrast
    // hairline divider plus generous vertical spacing so the段落层次 reads as
    // distinct visual blocks rather than walls of text. The divider colour
    // follows the theme so dark mode stays legible.
    final dividerColor =
